# Generated by Django 6.0.5 on 2026-05-15 06:56
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('PATIENT', 'Patient'), ('NURSE', 'Nurse'), ('ADMIN', 'Admin')], default='PATIENT', max_length=20)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('nurse', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='availabilities', to='api.nurseprofile')),
            ],
        ),
        migrations.CreateModel(
            name='Appointment',
            fields=[
                ...
                ('nurse', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='nurse_appointments', to='api.nurseprofile')),
            ],
        ),
    ]
